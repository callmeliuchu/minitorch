...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        a = grad_output.f.sigmoid_map(t1)
        b = a - grad_output.f.mul_zip(a,a)
...
class LT(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        # raise NotImplementedError('Need to implement for Task 2.4')
        a,b = ctx.saved_tensors
        return grad_output.zeros(b.shape),grad_output.zeros(a.shape)
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        ...
        data = a._tensor.permute(order.to_numpy())
        return a.make(*data.tuple())
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        ...
        # raise NotImplementedError('Need to implement for Task 2.4')
        a,order = grad_output
        data = grad_output._tensor.permute(order.to_numpy())
        return a.make(*data.tuple())
